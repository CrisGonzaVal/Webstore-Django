...
from .views import (
    ...
    agregar_producto, eliminar_producto, restar_producto, limpiar_carrito, agregar_producto_catalogo
)
...
urlpatterns = [
    ...
    path('agregar_p/<int:producto_id>/', agregar_producto_catalogo, name='agregar_producto'),
